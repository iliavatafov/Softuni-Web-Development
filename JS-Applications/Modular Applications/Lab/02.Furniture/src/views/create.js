...
const catalogTemplate = (onSubmit, errorMsg, errors) => html `
    <div class="container">
...
export function createPage(ctx) {
    ...
    function update(errorMsg, errors) {
        ctx.render(catalogTemplate(onSubmit, errorMsg, errors));
    }
    ...
    async function onSubmit(event) {
        ...
        try {
            if (missing.length > 0) {
                ...
                throw {
                    error: new Error('Please fill all mandatory fieleds!'),
                    errors
                } 
            }
